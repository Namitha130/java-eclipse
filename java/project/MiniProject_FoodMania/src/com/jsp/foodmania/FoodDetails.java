...
//	public void availability(double local_time) throws UnAvailableService
//	{
//		if (local_time >= 11.31 && local_time <= 11.59) 
//		{
...
//	}
	...
	// constructor for local time
	FoodDetails(double local_time) {
		this.local_time = local_time;
	}

	// method to give condition for local time
	public void local_timings() {
		if (local_time >= 06.00 && local_time <= 11.30) {
...
//			throw ie2;
	...
	public void display_Veg_breakfast() {
		...
		System.out.println("4. Puliyogare bath.........70rs");
